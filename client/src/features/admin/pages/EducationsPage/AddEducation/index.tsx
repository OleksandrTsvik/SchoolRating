			...
			>
				<Row gutter={[16, 16]}>
					<Col xs={24} md={24} xl={12}>
						<Form.Item className="m-0" label="Учитель" name="teacherId">
					...
					<Col xs={24} md={12} xl={6}>
						<Form.Item className="m-0" label="Клас" name="classId">
					...
					<Col xs={24} md={12} xl={6}>
						<Form.Item className="m-0" label="Предмет" name="subjectId">
